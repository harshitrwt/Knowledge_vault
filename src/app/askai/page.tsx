...
//       <main className="flex-1 flex flex-col p-4 sm:p-6 md:p-8 space-y-8">
...
//         <section className="bg-gray-950/60 backdrop-blur p-4 sm:p-6 rounded-2xl shadow-lg border border-gray-800">
...
//                 <div
//                   key={file.id}
//                   className="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-blue-600/20 border border-blue-600 hover:bg-blue-600/30 transition cursor-pointer group"
//                 >
//                   <FileText className="w-8 sm:w-10 h-8 sm:h-10 text-blue-400 mb-1 sm:mb-2 group-hover:scale-110 transition-transform" />
//                   <p className="text-xs sm:text-sm font-medium text-blue-300 truncate w-full text-center">
//                     {file.name}
//                   </p>
//                 </div>
//               ))}
...
//           className="flex flex-col items-center justify-center border-2 border-dashed border-blue-500 rounded-2xl p-6 sm:p-10 text-center transition hover:border-blue-400 hover:bg-blue-500/10"
//         >
//           <UploadCloud className="w-10 sm:w-12 h-10 sm:h-12 text-blue-400 mb-3" />
//           <p className="text-sm sm:text-lg text-gray-300">
//             Drag & drop a file here, or tap to upload
//           </p>
//           {droppedFile && (
//             <p className="mt-3 text-blue-400 text-sm sm:text-base font-semibold">
//               ✅ Ready: {droppedFile.name}
//             </p>
//           )}
//         </div>

//         <div className="w-full max-w-lg mx-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
//           <input
//             type="text"
//             placeholder="Ask me anything about your files..."
//             className="flex-1 px-4 py-3 rounded-xl border border-gray-800 bg-gray-950/80 text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
//           />
//           <button className="flex items-center justify-center gap-2 px-4 sm:px-5 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition shadow-md">
